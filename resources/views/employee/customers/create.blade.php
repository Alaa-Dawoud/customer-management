...
@section('content')
    <form action="{{route('employee.customers.store')}}" method="POST" enctype="multipart/form-data" class="advanced-form myForm" autocomplete="off" data-parsley-validate novalidate>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex">
                                ...
                                <a href="{{route('employee.customers.index')}}" class="btn btn-link link-secondary ms-auto">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
